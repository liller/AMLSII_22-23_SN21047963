"""Base_CNN_increased_layers contains the content about model construction, training and testing.
...
class Base_CNN_increased_layer:
    """
     Define class of Base_CNN_increased and compile

    """
    def __init__(self):
        print("===== Construct Base_CNN_increased model =====")
        ...
        print("===== Summary of the Base_CNN_increased model")
        self.model.summary()
    ...
    def train(self, train_batch, valid_batch, path, epochs= 30, plot= True):
        ...
        """
        print("Training Base_CNN_increased model =====")
    ...
    def test(self, test_batch, confusion_mat=False):
        ...
        """
        print("===== Test Base_CNN_increased model on test set=====")
